 ...
 *
 * Origin: https://github.com/likle/cargs/tree/master
 */
 ...
 *
 * This function gets an invalid option if an option doesn't match one of
 * options from `cag_option` list. This is useful if you want more detailed
 * error about an invalid option found.
 *
 * @param context The context from which the option was fetched.
 * @return Returns a string where it contains the invalid option.
 */
CAG_PUBLIC const char *
cag_option_get_invalid(const cag_option_context *context);
